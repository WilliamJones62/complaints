...
class ComplaintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post complaints_url, params: { complaint: { invoice: @complaint.invoice, issue: @complaint.issue, issue_date: @complaint.issue_date, part: @complaint.part, part_count: @complaint.part_count, user: @complaint.user } }
    end
  ...
  test "should update complaint" do
    patch complaint_url(@complaint), params: { complaint: { invoice: @complaint.invoice, issue: @complaint.issue, issue_date: @complaint.issue_date, part: @complaint.part, part_count: @complaint.part_count, user: @complaint.user } }
